...
<body>
<jsp:include page="page0.jsp" /><!--Summary-->      
<jsp:include page="page7.jsp" /><!--ATM -->
<jsp:include page="page3.jsp" /><!--Home Banking -->
<jsp:include page="page5.jsp" /><!--Corporate Banking -->
<jsp:include page="page11.jsp" /><!--Call Center-->
<jsp:include page="page6.jsp" /><!--Sportello-->
<jsp:include page="page9.jsp" /><!--PWS-->
<jsp:include page="page12.jsp" /><!--FEU-->
<jsp:include page="sonda.jsp" /><!--smsPolling -->
<jsp:include page="page10.jsp" /><!--Ticket-->
<jsp:include page="page4.jsp" /><!--Ribes-->
