	<div data-role="page" class="pageSwipe" id="page-ticket"  data-dom-cache="true" >
	...
	<a href="#nav-panelt" data-icon="bars" data-iconpos="notext">Menu</a>
	...
	<div role="main" class="ui-content"> 
   	 <p>      
  			<div style="width: 100%;">
					<img src="../kiroom/img/S01TCAT.png" alt="" style="width: 100%;">
			</div>
    ...
    <jsp:include page="menu_panel.jsp">
	   <jsp:param name="menu" value="nav-panelt" />
