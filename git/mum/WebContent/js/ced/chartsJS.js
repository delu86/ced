...
function drawWorkload(windowsTime,optionsChart,istituto,system,url_tail,idExporter){
    var url_json;
    switch(windowsTime){
    ...
    system==='ALL' ? url_json=url_json+url_tail : 
                     url_json=url_json+'&system='+system+url_tail;
    url_exporter=EXPORTER_URL+url_json;
    url_json=QUERY_RESOLVER_URL+url_json;
    $(idExporter).attr('href',url_exporter+'&title=workload_'+system);
    $.getJSON(url_json,function(json){
       optionsChart.series=[]; 
    var serie={
                   name:'',
