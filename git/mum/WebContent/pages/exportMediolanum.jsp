...
<body>
       ...
       <jsp:param name="profile" value="<%=profile %>" />
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Estrazione dati di dettaglio JOBTERM</h3>
                        <h4>record type 30 subtype 5 (max 3 giorni indietro)</h4>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                 <div class="row">
                    <div class="col-lg-12">
                        ...
                        <button  id="submit">Download .xls</button>
                        </form>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
    ...
    $("#submit").click(function(){
          location.href='exporter?title=exporter_'+date+'&id=ict1/jobtermExporter&date='+date;  
      });
    });
    </script>
