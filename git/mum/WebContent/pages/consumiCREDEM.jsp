...
String[] SID  = new String[4];
		...
		try {
			...
			File file = new File( webRootPath + File.separator  + "configCREDEM.properties");
			// System.out.println( webRootPath + File.separator  + "configCREDEM.properties" );
