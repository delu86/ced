    ...
    <script>
  	$(function() {
        ...
        $('.panel-heading')
                ...
                "exporter?title=cpuMf&id=smf113/mfCountersReale&date="+d
                +'"><img alt="excel" src="img/xls-48.png" height="24" width="24"></a></h5>'+
                'CPU MF counters');
                table.ajax.url("../queryResolver?id=smf113/mfCountersReale&date="+d).load();
        	$( "#datepicker" ).datepicker({ dateFormat: 'yymmdd', 
    			onSelect: function () {
                    ...
                    +'"><img alt="excel" src="img/xls-48.png" height="24" width="24"></a></h5>'+
                    'CPU MF counters');
  				table.ajax.url("../queryResolver?id=smf113/mfCountersReale&date="+$(this).val()).load();
