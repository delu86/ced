...
public class WorkloadExporterServlet extends HttpServlet {
	...
	private static final String OFFSET_PARAMETER = "offset";
        private static final String SELECT="SELECT substring(DATA_INT10,1,10)as giorno,substring(DATA_INT10,12,2) as ora ,SYSTEM,WKLOADNAME, sum(CPUTIME)*1026.5/3600 as MIPS from "+TABLE_PARAMETER_STRING+" where SYSTEM=? and"+
